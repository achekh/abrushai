...
const translations = {
  en: {
    ...
    'hero.description': 'Powerful AI plugin for Adobe Photoshop that transforms your creative process. Generation and editing in one click.',
    ...
    // Beta Form
    'beta.title': 'Get Early Access',
    'beta.subtitle': 'Be one of the first to try ABrush - the revolutionary AI plugin for Photoshop',
    'beta.name': 'Full Name',
    ...
    // Footer
    'footer.description': 'ABrush - Revolutionary tool for artists and illustrators that combines the power of artificial intelligence with Adobe Photoshop.',
    'footer.link.about': 'About',
    'footer.link.docs': 'Documentation',
    'footer.link.support': 'Support',
    'footer.link.privacy': 'Privacy Policy',
    'footer.contact': 'Contact',
    'footer.copyright': '© 2024 ABrush. All rights reserved.',
  ...
  uk: {
    ...
    'hero.description': 'Потужний AI плагін для Adobe Photoshop, який перетворює ваш творчий процес. Генерація та редагування в один клік.',
    ...
    // Beta Form
    'beta.title': 'Отримати ранній доступ',
    'beta.subtitle': 'Станьте одним з перших, хто випробує ABrush - революційний AI плагін для Photoshop',
    ...
    'beta.submit': 'Отримати ранній доступ',
    ...
    // Footer
    'footer.description': 'ABrush - Революційний інструмент для художників та ілюстраторів, який поєднує силу штучного інтелекту з Adobe Photoshop.',
    ...
    'footer.copyright': '© 2024 ABrush. Всі права захищені.',
